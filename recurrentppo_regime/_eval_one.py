...
# 最初の窓の warmup（z-score統計 + LSTM warmup + レジームHMMの最低学習日数
# REGIME_MIN_TRAIN）が確保できるよう余裕を持って取得（R-1 で 2018→2016 に前倒し）
...
# （R-1: レジーム版は nikkei_regime_*。観測次元が違う旧 rppo モデルは置かないこと）
